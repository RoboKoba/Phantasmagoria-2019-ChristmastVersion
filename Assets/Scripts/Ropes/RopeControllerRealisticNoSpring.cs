...
public class RopeControllerRealisticNoSpring : MonoBehaviour 
{
	...
	private void Update() 
	{
	    ...
	    //The above lookat rotation had a tendency to go crazy so just add a touch of random rotation instead
	    whatIsHangingFromTheRope.Rotate(Vector3.up, (Mathf.PerlinNoise(Time.time, 0f)-.5f)/2f);
    }
